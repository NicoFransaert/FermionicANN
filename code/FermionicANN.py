...
if __name__ == '__main__':
    ...
    # save_dir = 'C2_test_Complex'
    # save_dir = 'C2_test_Complex_SGD'
    save_dir = 'LiH_test_Complex_SGD'
    # save_dir = 'Heisenberg'
    # save_dir = 'sweep2_H2'
    ...
    if args.machine == 'rnn':
        run_FRNN(systemData=system, num_units = 50, num_layers = 1, learningrate = 5e-2, lrschedule='O', numsamples = 50000, numsteps = 2000, save_dir=save_dir)                          # use this for a single run
