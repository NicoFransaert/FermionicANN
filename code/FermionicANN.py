...
if __name__ == '__main__':
    ...
    if args.machine == 'rnn':
        ...
        run_FRNN(systemData=system, Complex=Complex, num_units = num_units, num_layers = num_layers, learningrate = lr, lrschedule=lrschedule, numsamples = 1000, numsteps = 2, save_dir=save_dir) # or this for argumetns from grid
